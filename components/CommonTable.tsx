      ...
      <div className="bg-card rounded-lg sm:rounded-xl shadow-sm border border-border">
            ...
            <thead>
              <tr className="border-b border-border">
                {columns.map(
                  (column) =>
                    columnVisibility[column.key] && (
                      <th
                        key={column.key}
                        className="px-3 sm:px-4 py-3 sm:py-3.5 text-left text-[10px] sm:text-xs font-bold text-foreground uppercase tracking-wide"
                      >
                        {column.label}
                      </th>
                    ),
                ...
                {showActions && columnVisibility.actions && (
                  <th className="px-3 sm:px-4 py-3 sm:py-3.5 text-left text-[10px] sm:text-xs font-bold text-foreground uppercase tracking-wide">
                    ACTION
                  </th>
                )}
              </tr>
        ...
        <div className="px-3 sm:px-6 py-3 sm:py-4 border-t border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              className="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center text-white text-xs sm:text-sm font-semibold rounded-lg shadow-sm disabled:opacity-50"
          ...
          <table className="w-full border-separate border-spacing-y-2 min-w-[600px]">
            <thead>
              <tr className="bg-background">
                {columns.map(
                  (column) =>
                    columnVisibility[column.key] && (
                      <th
                        key={column.key}
                        className="px-3 sm:px-6 py-3 sm:py-3.5 text-left text-[10px] sm:text-xs font-bold text-foreground uppercase tracking-wide"
                      >
                        {column.label}
                      </th>
                    ),
                ...
                {showActions && columnVisibility.actions && (
                  <th className="px-3 sm:px-6 py-3 sm:py-3.5 text-left text-[10px] sm:text-xs font-bold text-foreground uppercase tracking-wide">
                    ACTION
                  </th>
                )}
              </tr>
                    ...
                    <td className="px-3 sm:px-6 py-3 sm:py-4">
                      <div className="flex items-center gap-2 sm:gap-4">
                        {onEdit && (
                          <button
                            onClick={() => onEdit(row)}
                            className="text-foreground opacity-50 p-1 cursor-pointer"
                          >
                            <Edit2 className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                          </button>
                        )}
