...
import { ConfigurationFormData } from "@/interfaces/configuration.interface";
...
const NewConfiguration: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const filteredLanguages = Array.from(new Set(
                additionalLanguages.filter(lang => lang.trim() !== "")
            ));
            ...
            const payload = {
                ...
                allowedLanguages: filteredLanguages.length > 0 ? filteredLanguages : undefined,
            };
            ...
            <div className={`min-h-screen ${isDark ? "bg-background" : ""} p-2`}>
                ...
                <div className="max-w-6xl mx-auto mb-8 px-4">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        ...
                        <button
                            className={`w-full sm:w-auto px-4 sm:px-6 py-2 rounded-lg font-medium transition-colors ${isDark
                ...
                {loading && isEditMode ? (
                    ...
                    <div className="max-w-6xl mx-auto space-y-6">
                            ...
                            <div>
                                ...
                                {isEditMode && (
                                    <p className={`text-xs mt-1 ${isDark ? "text-gray-400" : "text-gray-500"}`}>
                                        Account ID cannot be changed in edit mode
                                    </p>
                                )}
                            </div>
                        </Card>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-end gap-10">
                                        ...
                                        <button
                                            ...
                                            className={`w-[48%] border border-dotted border-border rounded-lg flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium transition-colors ${isDark
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            >
                                {loading ? "Saving..." : isEditMode ? "Update Configuration" : "Save Configuration"}
                            </button>
                        </div>
                    </div>
                )}
