...
const PlansManagement = () => {
    ...
    const contractValidities = ["1 Month", "3 Months", "6 Months", "1 Year", "2 Years", "3 Years"];
    const pricingModels = ["Fixed (Flat Account-based)", "Per User", "Tiered", "Usage-based"];
    ...
    const fetchPlanDetails = async () => {
        ...
        setTimeout(() => {
            setFormData({
                planName: "Premium Distributor Hub",
                tenantCategory: "End User (Direct)",
                settlementCurrency: "USD ($)",
                billingInterval: "Monthly",
                contractValidity: "1 Year",
                pricingModel: "Fixed (Flat Account-based)",
                initialBasePrice: "299",
                amcCharge: "50",
                platformSubCharge: "25",
                hardwareRestrictions: false,
                userCreationLimit: "0",
                supportNumber: "+1-XXX-XXX-XXXX",
    ...
    const entitlementsList = [
        { key: "liveTracking", icon: MapPin, label: "LIVE TRACKING", desc: "Real-time asset movement updates" },
        { key: "historyPlayback", icon: Activity, label: "HISTORY PLAYBACK", desc: "Access to historical route data" },
        { key: "geofencing", icon: Cpu, label: "GEOFENCING", desc: "Virtual boundaries and alerts" },
        { key: "fuelAnalytics", icon: TrendingUp, label: "FUEL ANALYTICS", desc: "Fuel level and consumption tracking" },
        { key: "driverBehavior", icon: Activity, label: "DRIVER BEHAVIOR", desc: "Harsh braking, acceleration, idling" },
        { key: "maintenance", icon: Cpu, label: "MAINTENANCE", desc: "Service reminders and logs" },
        { key: "apiAccess", icon: Database, label: "API ACCESS", desc: "External integration capabilities" },
        { key: "advancedReports", icon: BarChart3, label: "ADVANCED REPORTS", desc: "Scheduled PDF/Excel reporting" },
    ];

    return (
        <div className={`${isDark ? "dark" : ""} min-h-screen bg-gray-50 p-6`}>
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                        ...
                        <div className="flex gap-3 w-full sm:w-auto">
                            ...
                            <button
                                className="flex-1 sm:flex-none text-white px-6 py-3 rounded-lg flex items-center justify-center gap-2 font-medium transition-colors"
                                style={{ background: selectedColor }}
                                onClick={handleSubmit}
                            >
                                <Package className="w-5 h-5" />
                                <span>{isEditMode ? "Update Plan" : "Save & Activate"}</span>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <Card isDark={isDark}>
                                <div className="flex items-center gap-2 mb-4">
                                    <CreditCard className="w-5 h-5" style={{ color: selectedColor }} />
                                ...
                                {entitlementsList.map(({ key, icon: Icon, label, desc }) => (
                                    ...
                                    >
                                        <div className="flex items-start gap-3">
                                            <div className={`p-2 rounded-lg ${entitlements[key] ? "bg-purple-500" : "bg-gray-200"}`}>
                                                <Icon className={`w-5 h-5 ${entitlements[key] ? "text-white" : "text-gray-600"}`} />
                                            </div>
                                            <div className="flex-1">
                                                ...
                                                <p className={`text-xs ${isDark ? "text-gray-400" : "text-gray-600"}`}>{desc}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                        ...
                        <Card isDark={isDark}>
                            <div className="flex items-center gap-2 mb-2">
                                <Smartphone className="w-5 h-5" style={{ color: selectedColor }} />
                                <h3 className={`text-base font-bold ${isDark ? "text-white" : "text-gray-900"}`}>
                                    Hardware Binding & Access Control
                                </h3>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        <Users className="w-4 h-4" style={{ color: selectedColor }} />
                        ...
                        <Card isDark={isDark}>
                            <div className="flex items-center gap-2 mb-2">
                                <Headphones className="w-5 h-5" style={{ color: selectedColor }} />
                                <h3 className={`text-base font-bold ${isDark ? "text-white" : "text-gray-900"}`}>
                                    Dedicated Support Line
                                </h3>
                            </div>
                        ...
                        >
                            ...
                            <div className="px-6 pb-6 space-y-4">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-sm font-bold" style={{ color: selectedColor }}>
                                        {formData.usersLimit || "N/A"}
                                    </span>
                                </div>

                                <div className="mt-8 pt-6 border-t border-gray-200">
                                    <div className="text-center">
                                        <div className="text-5xl font-bold mb-2" style={{ color: selectedColor }}>
                                            {formData.settlementCurrency?.includes("$") ? "$" : ""}
                                            {formData.basePrice || "0"}
                                        </div>
                                        <p className={`text-sm uppercase tracking-wide ${isDark ? "text-gray-400" : "text-gray-600"
                                            }`}>
                                            PER {formData.billingInterval?.toUpperCase() || "MONTH"}
                                        </p>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        />
                                        <div>
                                            <p className="text-xs font-bold mb-1" style={{ color: selectedColor }}>
                                                CONTRACT TERM
                                            </p>
                                            <p
